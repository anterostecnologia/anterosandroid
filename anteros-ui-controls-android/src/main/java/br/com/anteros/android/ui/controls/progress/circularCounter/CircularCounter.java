...
package br.com.anteros.android.ui.controls.progress.circularCounter;
...
public class CircularCounter extends View {
	...
	private void init(TypedArray a) {
		...
		mTextSize = a.getDimension(R.styleable.CircularMeter_textSize,
				getResources().getDimension(R.dimen.circular_counter_textSize));
		mTextColor = a
				.getColor(R.styleable.CircularMeter_textColor, mTextColor);

		mMetricSize = a.getDimension(R.styleable.CircularMeter_metricSize,
				getResources().getDimension(R.dimen.circular_counter_metricSize));
		mMetricText = a.getString(R.styleable.CircularMeter_metricText);
		mMetricPaddingY = getResources().getDimension(R.dimen.circular_counter_metricPaddingY);

		mRange = a.getInt(R.styleable.CircularMeter_range, 100);

		mOneWidth = getResources().getDimension(R.dimen.circular_counter_width);
		mTwoWidth = getResources().getDimension(R.dimen.circular_counter_width);
		mThreeWidth = getResources().getDimension(R.dimen.circular_counter_width);
