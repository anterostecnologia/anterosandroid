...
package br.com.anteros.android.ui.controls.scroll;
...
import br.com.anteros.android.ui.controls.scroll.Scrollable;

public class AnterosFastScroll extends View {
    ...
    public AnterosFastScroll(Context context) {
        super(context);
    }

    public AnterosFastScroll(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AnterosFastScroll(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    /**
     * Initializing the AnterosFastScroll, this function must be called.
     * <p/>
     *
     * @param type       the AnterosFastScroll type. Available inputs: <b>AnterosFastScroll.TYPE_POPUP</b> or <b>AnterosFastScroll.TYPE_INDICATOR</b>
    ...
    /**
     * Sets the indicator colors, when AnterosFastScroll.TYPE_INDICATOR is selected as type.
     * <p/>
     *
    ...
    /**
     * Sets the popup colors, when AnterosFastScroll.TYPE_POPUP is selected as type.
     * <p/>
     *
