...
public final class AnterosCropImage {

    //region: Fields and Consts

    /**
     * The key used to pass crop image source URI to {@link AnterosCropImageActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

    /**
     * The key used to pass crop image options to {@link AnterosCropImageActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

    /**
     * The key used to pass crop image result data back from {@link AnterosCropImageActivity}.
     */
    ...
    /**
     * The request code used to start {@link AnterosCropImageActivity} to be used on result to identify the this specific
     * request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

    /**
     * The result code used to return error from {@link AnterosCropImageActivity}.
     */
    public static final int CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE = 204;
    //endregion

    private AnterosCropImage() {
    }
     ...
     * {@link AnterosCropImageActivity} to crop the selected image.<br>
    ...
    /**
     * Create {@link ActivityBuilder} instance to start {@link AnterosCropImageActivity} to crop the given image.<br>
     * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} and can be retrieved
     * using {@link #getActivityResult(Intent)}.
     *
    ...
    /**
     * Get {@link AnterosCropImageActivity} result data object for crop image activity started using {@link #activity(Uri)}.
     *
    ...
    public static final class ActivityBuilder {
         ...
         */
        private final AnterosCropImageOptions mOptions;

        private ActivityBuilder(@Nullable Uri source) {
            mSource = source;
            mOptions = new AnterosCropImageOptions();
        }

        /**
         * Get {@link AnterosCropImageActivity} intent to start the activity.
         */
        public Intent getIntent(@NonNull Context context) {
            return getIntent(context, AnterosCropImageActivity.class);
        }
        ...
        public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls) {
            ...
            intent.putExtra(AnterosCropImageOptions.BUNDLE_KEY, bundle);
            return intent;
        }

        /**
         * Start {@link AnterosCropImageActivity}.
         *
         ...
         */
        public ActivityBuilder setCropShape(@NonNull AnterosCropImageView.CropShape cropShape) {
         ...
         */
        public ActivityBuilder setGuidelines(@NonNull AnterosCropImageView.Guidelines guidelines) {
         ...
         */
        public ActivityBuilder setScaleType(@NonNull AnterosCropImageView.ScaleType scaleType) {
        ...
        /**
         * the title of the {@link AnterosCropImageActivity}.<br>
         * <i>Default: ""</i>
         */
         ...
         * Uses {@link AnterosCropImageView.RequestSizeOptions#RESIZE_INSIDE} option.<br>
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public ActivityBuilder setRequestedSize(int reqWidth, int reqHeight) {
            return setRequestedSize(reqWidth, reqHeight, AnterosCropImageView.RequestSizeOptions.RESIZE_INSIDE);
        }
         ...
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public ActivityBuilder setRequestedSize(int reqWidth, int reqHeight, AnterosCropImageView.RequestSizeOptions options) {
     ...
     */
    public static final class ActivityResult extends AnterosCropImageView.CropResult implements Parcelable {
