...
package br.com.anteros.android.ui.controls.floatingActionButton;
...
public class FloatingActionsMenu extends ViewGroup {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		case EXPAND_RIGHT:
			...
			mAddButton.layout(addButtonX, addButtonTop, addButtonX + mAddButton.getMeasuredWidth(), addButtonTop
					+ mAddButton.getMeasuredHeight());
