 ...
 */
final class AnterosCropImageAnimation extends Animation implements Animation.AnimationListener {
    ...
    public AnterosCropImageAnimation(ImageView cropImageView, AnterosCropOverlayView cropOverlayView) {
