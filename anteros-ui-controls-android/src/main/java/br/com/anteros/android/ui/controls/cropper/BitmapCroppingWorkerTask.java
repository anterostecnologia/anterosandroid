...
final class BitmapCroppingWorkerTask extends AsyncTask<Void, Void, BitmapCroppingWorkerTask.Result> {
     ...
     */
    private final WeakReference<AnterosCropImageView> mCropImageViewReference;
     ...
     */
    private final AnterosCropImageView.RequestSizeOptions mReqSizeOptions;
    ...
    BitmapCroppingWorkerTask(AnterosCropImageView cropImageView, Bitmap bitmap, float[] cropPoints,
                             int degreesRotated, boolean fixAspectRatio, int aspectRatioX, int aspectRatioY,
                             int reqWidth, int reqHeight, boolean flipHorizontally, boolean flipVertically, AnterosCropImageView.RequestSizeOptions options,
    ...
    BitmapCroppingWorkerTask(AnterosCropImageView cropImageView, Uri uri, float[] cropPoints,
                             ...
                             boolean flipHorizontally, boolean flipVertically, AnterosCropImageView.RequestSizeOptions options,
                             Uri saveUri, Bitmap.CompressFormat saveCompressFormat, int saveCompressQuality) {
    ...
    protected void onPostExecute(Result result) {
        if (result != null) {
            ...
            if (!isCancelled()) {
                AnterosCropImageView cropImageView = mCropImageViewReference.get();
