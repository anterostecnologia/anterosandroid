...
package br.com.anteros.android.ui.controls.tablefixheaders;
...
import br.com.anteros.android.ui.controls.tablefixheaders.adapter.TableAdapter;
...
public class TableFixHeaders extends ViewGroup {
		...
		case MotionEvent.ACTION_UP: {
			...
			if (velocityTracker != null) {
				...
				if (Math.abs(velocityX) > minimumVelocity || Math.abs(velocityY) > minimumVelocity) {
					...
					if (this.velocityTracker != null) { // If the velocity less
														// than
														// threshold
	...
	private void shadowsVisibility() {
		...
		final int[] remainPixels = { actualScrollX, actualScrollY, getMaxScrollX() - actualScrollX,
