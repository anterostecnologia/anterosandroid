...
package br.com.anteros.android.ui.controls.progress.numericProgress;
 ...
 */
public class NumericProgressBar extends View {
    ...
    public NumericProgressBar(Context context) {
        this(context, null);
    }

    public NumericProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.numberProgressBarStyle);
    }

    public NumericProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
