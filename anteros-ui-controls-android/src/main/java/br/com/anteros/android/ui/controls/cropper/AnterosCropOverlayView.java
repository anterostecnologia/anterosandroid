 ...
 */
public class AnterosCropOverlayView extends View {
     ...
     */
    private final AnterosCropWindowHandler mCropWindowHandler = new AnterosCropWindowHandler();
     ...
     */
    private AnterosCropWindowMoveHandler mMoveHandler;
     ...
     */
    private AnterosCropImageView.Guidelines mGuidelines;

    /**
     * The shape of the cropping area - rectangle/circular.
     */
    private AnterosCropImageView.CropShape mCropShape;
    ...
    public AnterosCropOverlayView(Context context) {
        this(context, null);
    }

    public AnterosCropOverlayView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public AnterosCropImageView.CropShape getCropShape() {
        return mCropShape;
    }
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public void setCropShape(AnterosCropImageView.CropShape cropShape) {
        if (mCropShape != cropShape) {
            mCropShape = cropShape;
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17) {
                if (mCropShape == AnterosCropImageView.CropShape.OVAL) {
     ...
     */
    public AnterosCropImageView.Guidelines getGuidelines() {
        return mGuidelines;
    }
     ...
     */
    public void setGuidelines(AnterosCropImageView.Guidelines guidelines) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCropWindowHandler.showGuidelines()) {
            ...
            if (mGuidelines == AnterosCropImageView.Guidelines.ON) {
                drawGuidelines(canvas);
            } else if (mGuidelines == AnterosCropImageView.Guidelines.ON_TOUCH && mMoveHandler != null) {
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (mCropShape == AnterosCropImageView.CropShape.RECTANGLE) {
            ...
            mPath.reset();
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17 && mCropShape == AnterosCropImageView.CropShape.OVAL) {
    ...
    private void drawCorners(Canvas canvas) {
        if (mBorderCornerPaint != null) {
            ...
            float w = cornerWidth / 2 + (mCropShape == AnterosCropImageView.CropShape.RECTANGLE ? mBorderCornerOffset : 0);
