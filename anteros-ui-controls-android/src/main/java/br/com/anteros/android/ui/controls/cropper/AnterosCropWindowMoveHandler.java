 ...
 */
final class AnterosCropWindowMoveHandler {
     ...
     */
    public AnterosCropWindowMoveHandler(Type type, AnterosCropWindowHandler cropWindowHandler, float touchX, float touchY) {
        mType = type;
