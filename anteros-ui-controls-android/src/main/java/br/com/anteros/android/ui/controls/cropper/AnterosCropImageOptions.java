 ...
 */
public class AnterosCropImageOptions implements Parcelable {

    static final String BUNDLE_KEY = "bundle";

    public static final Creator<AnterosCropImageOptions> CREATOR = new Creator<AnterosCropImageOptions>() {
        @Override
        public AnterosCropImageOptions createFromParcel(Parcel in) {
            return new AnterosCropImageOptions(in);
        }

        @Override
        public AnterosCropImageOptions[] newArray(int size) {
            return new AnterosCropImageOptions[size];
        }
    };
     ...
     */
    public AnterosCropImageView.CropShape cropShape;
     ...
     */
    public AnterosCropImageView.Guidelines guidelines;

    /**
     * The initial scale type of the image in the crop image view
     */
    public AnterosCropImageView.ScaleType scaleType;
    ...
    /**
     * the title of the {@link AnterosCropImageActivity}
     */
     ...
     */
    public AnterosCropImageView.RequestSizeOptions outputRequestSizeOptions;
     ...
     */
    public AnterosCropImageOptions() {

        DisplayMetrics dm = Resources.getSystem().getDisplayMetrics();

        cropShape = AnterosCropImageView.CropShape.RECTANGLE;
        ...
        guidelines = AnterosCropImageView.Guidelines.ON_TOUCH;
        scaleType = AnterosCropImageView.ScaleType.FIT_CENTER;
        ...
        outputRequestSizeOptions = AnterosCropImageView.RequestSizeOptions.NONE;
        noOutputImage = false;
     ...
     */
    protected AnterosCropImageOptions(Parcel in) {
        cropShape = AnterosCropImageView.CropShape.values()[in.readInt()];
        snapRadius = in.readFloat();
        touchRadius = in.readFloat();
        guidelines = AnterosCropImageView.Guidelines.values()[in.readInt()];
        scaleType = AnterosCropImageView.ScaleType.values()[in.readInt()];
        ...
        outputRequestSizeOptions = AnterosCropImageView.RequestSizeOptions.values()[in.readInt()];
